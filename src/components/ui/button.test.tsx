...
describe('Button component ', () => {
  ...
  it('should apply correct styles based on size prop', () => {
    ...
    const expectedStyle =
      'font-audiowide font-semibold text-white dark:text-black text-xl';
    const receivedStyle =
  ...
  it('should apply correct styles for label when variant is secondary', () => {
    ...
    const expectedStyle =
      'font-audiowide font-semibold text-secondary-600 text-base';
    const receivedStyle =
      button.props.children[0].props.children.props.className;
    expect(receivedStyle).toContain(expectedStyle);
  });
  it('should apply correct styles for label when is disabled', () => {
    ...
    const expectedStyle =
      'font-audiowide font-semibold text-base text-neutral-600 dark:text-neutral-600';
    const receivedStyle =
      button.props.children[0].props.children.props.className;
    expect(receivedStyle).toContain(expectedStyle);
  });
